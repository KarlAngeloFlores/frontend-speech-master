                ...
                <div key={entry.id} className="relative">
                  ...
                  <div className="flex gap-4">
                    ...
                    <div className="flex-shrink-0">
                      <div className="w-12 h-12 rounded-full bg-blue-100 border-2 border-blue-300 flex items-center justify-center text-lg">
                        📝
                      </div>
                    </div>

                    {/* Entry content */}
                    <div className="flex-1 bg-gray-50 border-2 border-gray-200 rounded-lg p-4 hover:border-blue-300 transition-all">
