...
const RestoreModuleModal = ({ isOpen, onClose, onRestore, module }) => {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/30">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md p-8 modal-animation">
        ...
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-2xl font-bold text-green-600">Restore Module</h2>
          <button
...
export default RestoreModuleModal