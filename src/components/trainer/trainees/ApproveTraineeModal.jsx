    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md p-8 modal-animation">
        ...
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-2xl font-bold text-green-600">Approve trainee</h2>
          <button
            onClick={onClose}
        ...
        <div className="flex gap-3 mt-6">
          ...
          <button
            ...
            disabled={loading}
            className="flex-1 px-4 py-2 rounded-lg text-white bg-gradient-to-r from-green-600 to-green-700 hover:from-green-700 hover:to-green-800 flex items-center justify-center gap-2 transition cursor-pointer disabled:cursor-not-allowed"
          >
            <UserCheck size={18} />
